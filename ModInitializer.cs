		...
		{
			{
				...
				var harmony = new Harmony("MoreEvent");   // 格式：模组ID.作者名
				harmony.PatchAll();
				...
				ModHelper.AddModelToPool(typeof(EventCardPool), typeof(GalacticRoamingGuide));
				...
				ModHelper.AddModelToPool(typeof(EventRelicPool), typeof(BluePuppet));
